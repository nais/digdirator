...
func assertSecretExists(t *testing.T, name string, namespace string, instance *v1.MaskinportenClient) {
	...
	assert.NotEmpty(t, a.Data[v1.MaskinportenJwkKey])
	assert.NotEmpty(t, a.Data[v1.MaskinportenClientID])
	assert.NotEmpty(t, a.Data[v1.MaskinportenScopes])
	assert.NotEmpty(t, a.Data[v1.MaskinportenWellKnownURL])

	assert.Empty(t, a.Data[v1.IDPortenClientID])
	assert.Empty(t, a.Data[v1.IDPortenJwkKey])
	assert.Empty(t, a.Data[v1.IDPortenRedirectURI])
	assert.Empty(t, a.Data[v1.IDPortenWellKnownURL])
}
